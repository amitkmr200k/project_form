...
{	
    ...
    if ($_FILES['image']['name']) 
    {
        ...
        {
            move_uploaded_file($_FILES['image']['tmp_name'], "/var/www/html/projects/assignment/img/$img_var");
        }
    }
    ...
    if (empty($error))
    {
        ...
        $password = md5($_POST['password'].md5($_POST['user_name']));
        
        $query = "INSERT INTO user(first_name,middle_name,last_name,email_id,
            user_name,password,gender,age,dob,marital_status,employment,
            employer,residence_street,residence_city,residence_state,
            residence_pincode,residence_contact_no,residence_fax_no,
            permanent_street,permanent_city,permanent_state,
            permanent_pincode,permanent_contact_no,permanent_fax_no,comment,
            image,activate_code)
            VALUES('{$_POST["first_name"]}','{$_POST["middle_name"]}',
            '{$_POST["last_name"]}','{$_POST["email_id"]}','{$_POST["user_name"]}',
            '{$password}','{$_POST["gender"]}','{$_POST["age"]}',
            '{$_POST["dob"]}','{$_POST["marital_status"	]}','{$_POST["employment"]}',
            '{$_POST["employer"]}','{$_POST["residence_street"]}',
            '{$_POST["residence_city"]}','{$_POST["residence_state"]}',
            '{$_POST["residence_pincode"]}','{$_POST["residence_contact_no"]}',
            '{$_POST["residence_fax_no"]}','{$_POST["permanent_street"]}',
            '{$_POST["permanent_city"]}','{$_POST["permanent_state"]}',
            '{$_POST["permanent_pincode"]}','{$_POST["permanent_contact_no"]}',
            '{$_POST["permanent_fax_no"]}','{$_POST["comment"]}','{$img_var}',
            '{$activate}')";
